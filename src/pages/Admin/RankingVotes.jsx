...
export const RankingVotes = () => {
    ...
    useEffect( () => {
     ...
     const updateUser = (data) => {
      setTitleModal('Editar fotografía de ' + data.first_name + ' ' + data.last_name);
  ...
  return (
    <>
        <FormRanking getVotesManual={getVotesManual} stage_one={()=> updateStage(1)} stage_two={()=> updateStage(2)}/>
